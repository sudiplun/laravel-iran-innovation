                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                ...
                                <!-- news title -->
                                <h1 class="news-title"><a href="news-single.html">more than 80 clinical trials launch to
                                        test of the coronavirus .</a></h1>
                                <!-- meta -->
                                <div class="meta">
                                    <div class="meta-left">
                                        <span class="author"><a href="#"><img
                                                    src="{{ url('frontend/img/author1.jpg') }}" alt="#">naimur
                                                rahman</a></span>
                            ...
                            <div class="blog-comments">
                                ...
                                <div class="comments-body">
                                    ...
                                    <div class="single-comments left">
                                        <div class="main">
                                            <div class="head">
                                                <img src="{{ url('frontend/img/author2.jpg') }}" alt="#" />
                                            </div>
                                            <div class="body">
                                                <h4>naimur rahman</h4>
                                                <div class="comment-meta"><span class="meta"><i
                                    ...
                                    <div class="single-comments">
                                        <div class="main">
                                            <div class="head">
                                                <img src="{{ url('frontend/img/author3.jpg') }}" alt="#" />
                                            </div>
                                            <div class="body">
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            ...
                            <div class="single-post">
                                <div class="image">
                                    <img src="{{ url('frontend/img/blog-sidebar1.jpg') }}" alt="#">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-post">
                                <div class="image">
                                    <img src="{{ url('frontend/img/blog-sidebar2.jpg') }}" alt="#">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-post">
                                <div class="image">
                                    <img src="{{ url('frontend/img/blog-sidebar3.jpg') }}" alt="#">
                                </div>
                                <div class="content">
