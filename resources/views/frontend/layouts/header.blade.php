            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-12">
                        <!-- Start Logo -->
                        <div class="logo">
                            <a href="{{ route('mediplus.index') }}"><img src="{{ url('frontend/img/logo.png') }}" alt="#"></a>
                        </div>
                        <!-- End Logo -->
                        <!-- Mobile Nav -->
                            ...
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li><a href="#">Blogs <i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="{{ route('mediplus.blog') }}">Blog Details</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ route('mediplus.contact') }}">Contact Us</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!--/ End Main Menu -->
